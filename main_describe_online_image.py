...
# defalut_llm = ChatOpenAI(base_url=os.environ.get("OPENAI_API_BASE_URL", "https://api.openai.com/v1"),
...
Router_Agent = Agent(
  role='Router',
  goal='Route user question to a text to image to text',
  backstory=(
...
router_task = Task(
    ...
    expected_output=("Give a choice 'image2text' based on the question {question} and image url {image_url}"
